...
1. **Actualitzar la instal·lacio de la VPS a la v0.4.2**, que es la primera actualitzacio de debo --amb dades a dins-- i no una instal·lacio de zero, que funciona sempre. Cal agafar el `update.sh` nou primer: el que hi ha instal·lat es de la v0.4.1 i nomes sap llegir `release.env`.
