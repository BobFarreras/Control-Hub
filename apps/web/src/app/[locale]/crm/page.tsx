...
export default async function CrmPage({ params, searchParams }: { params: Promise<{ locale: string }>; searchParams: Promise<{ search?: string }> }) {
  ...
  const nav = [[t.navigation.dashboard, LayoutDashboard, `/${locale}`], [t.navigation.customers, Users, `/${locale}/crm`], [t.navigation.products, Package, "#"], [t.navigation.subscriptions, CircleDollarSign, "#"], [t.navigation.support, Headphones, "#"], [t.navigation.infrastructure, CloudCog, "#"], [t.navigation.integrations, Boxes, "#"], [t.navigation.settings, Settings, `/${locale}/security`]] as const;
