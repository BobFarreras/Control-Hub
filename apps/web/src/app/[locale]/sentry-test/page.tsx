    ...
    <main style={{ padding: "40px", maxWidth: "600px", margin: "0 auto" }}>
      ...
      <div style={{ marginTop: "20px", padding: "15px", backgroundColor: "#f8f9fa", borderRadius: "8px" }}>
        ...
        <ol>
          ...
          <li>Vés a <a href="https://sentry.io" target="_blank" rel="noopener noreferrer">Sentry.io</a></li>
      ...
      <div style={{ marginTop: "30px", padding: "15px", backgroundColor: "#fff3cd", borderRadius: "8px" }}>
        ...
        <p>
          Sentry només captura errors a <strong>producció</strong> (quan <code>NODE_ENV=production</code>).
          En desenvolupament, els errors van a la consola del navegador.
        </p>
        <p>
          Per provar a producció, desplega el servei i visita aquesta pàgina.
        </p>
      </div>
    </main>
  );
